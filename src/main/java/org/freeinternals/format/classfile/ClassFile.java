...
//                System.out.println ();
    ...
    private class CPDescr {
        ...
        private String getDescr_ref(final int classindex, final int natindex, final Descr_NameAndType type) {
        ...
        private String getDescr_NameAndType(final ConstantNameAndTypeInfo info, final Descr_NameAndType format) {
            final StringBuilder sb = new StringBuilder();
            String type;
